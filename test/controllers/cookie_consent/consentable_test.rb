...
class ConsentableTest < ActionDispatch::IntegrationTest
  ...
  class DummyController < ActionController::Base
    ...
    def index
      render plain: @show_cookie_consent.to_s
    end
  end
  ...
  test "sets @show_cookie_consent to true when cookie is missing" do
    get "/dummy"
    assert_response :success
    assert_equal "true", @response.body
  end

  test "sets @show_cookie_consent to false when cookie exists" do
